...
include('../service/functions.php');
	...
	if(isset($_POST['showcomplain'])){
		...
		if($studentcomplain){
				...
				while($row = mysqli_fetch_assoc($studentcomplain)){
...
?>	
	<html>
			...
			<body>
				<form action="../php/giveSReply.php"   method="post" onsubmit="return Validation()" name="scomplainForm"  >
					...
					<tr>
					<tr>
						<td><div align="left"><a href="../views/enquerystudent.php">Back</a></div> </td>
						<td> </td>
					</tr>
				...
				<script type="text/javascript">
								...
								var id=document.forms["scomplainForm"]["id"];
								var Reply=document.forms["scomplainForm"]["Reply"];
