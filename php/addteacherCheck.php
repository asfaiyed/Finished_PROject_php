...
session_start();
			...
			if(($fullname==true) AND ($nickname==true) AND ($pass==true)){
					...
					$reg = register($fname, $nname, $password, $email,$folder,$education,$type,$gender);
										if($reg){
											...
											<tr>
											<td width=300px text-align:center><span style='color:#00FF00'><b>Teacher has been added!</b></span></td>
											</tr>
	...
	echo "<div align='left'><a href='../views/teacherinformation.php'>Back</a></div>";
